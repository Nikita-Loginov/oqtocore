      ...
      <Container>
        <StoriesInner>
          <StoriesBox className="stories-box-img-bottom">
            ...
            <picture>
              <source srcSet="./images/stories/gtm.webp" type="image/webp" />
              <source srcSet="./images/stories/gtm.webp 2x" type="image/webp" />
              <source srcSet="./images/stories/gtm.png" type="image/png" />
              <StoriesImg
                loading="lazy"
          ...
          <StoriesBox className="stories-box-img-top">
            <picture>
              <source srcSet="./images/stories/runes.webp" type="image/webp" />
              <source
                srcSet="./images/stories/runes2x.webp 2x"
                type="image/webp"
              />
              <source srcSet="./images/stories/runes.png" type="image/png" />
              <StoriesImg
                loading="lazy"
