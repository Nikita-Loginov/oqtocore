...
const infoCasesTop = {
  title: "Pioneering a Fungible Token Protocol on the Bitcoin Network.",
  text: [
  ...
  items: [
    {
      ...
      title: 'Blockchain R&D (Research and Development)',
      text: 'Blockchain R&D involves the exploration and creation of new technologies within the blockchain ecosystem. This encompasses the development of innovative blockchain protocols, improvements to scalability and security, and the integration of blockchain with other emerging technologies like AI and IoT.'
    },
    {
      id: 2,
      iconSrc: '/icons/setting.svg',
      title: 'Blockchain QA (Quality Assurance) Infrastructure',
      text: 'Blockchain QA infrastructure refers to the systems and processes put in place to ensure the quality and reliability of blockchain applications. This involves testing blockchain solutions across various parameters such as performance, security, and user experience to identify and fix bugs or vulnerabilities.'
    },
  ]
}
  ...
  useEffect(() => {
    ...
    function setMarginLeftCaseTop() {
      if (window.innerWidth > 1279) {
        ...
        const marginLeft =
          parseFloat(stylesContainer.marginLeft) +
          parseFloat(stylesContainer.paddingLeft);
  ...
  return (
    <>
      ...
      <main className="main cases-item-page" ref={main}>
        ...
        <Stories
          info={infoStoriesItems}
          preloaderTextStories={preloaderTextStories}
          countVisibleItems={countVisibleItems}
          titleBlockStories={titleBlockStories}
        />
